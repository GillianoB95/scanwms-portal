    ...
    <div className="min-h-screen flex">
      ...
      `}>
        <div className="h-16 flex items-center px-6 border-b border-[hsl(var(--sidebar-border))]">
          <Link to="/warehouse" className="flex items-center gap-2" onClick={() => setMobileOpen(false)}>
            <Warehouse className="h-6 w-6 text-[hsl(var(--sidebar-active))]" />
            <span className="text-lg font-bold tracking-tight text-[hsl(var(--sidebar-active))]">SCAN</span>
            <span className="text-lg font-bold tracking-tight text-primary-foreground">WMS</span>
          </Link>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-30 h-16 flex items-center justify-between px-4 lg:px-8 bg-card border-b">
          ...
          <div className="hidden lg:flex items-center gap-2">
            <span className="text-xs font-medium px-2 py-1 rounded-full bg-accent text-accent-foreground">Warehouse Portal</span>
          </div>
