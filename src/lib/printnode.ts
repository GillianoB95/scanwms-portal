...
// Generate pallet label HTML as base64 for PrintNode (10x15cm thermal label)
...
<style>
  ...
  .barcode-area { text-align: center; margin: 2mm 0; padding: 2mm; border: 2px solid #2563eb; }
  ...
  .cargo { background: #15803d; color: #fff; font-size: 13pt; font-weight: bold; text-align: center; padding: 2mm; margin: 1mm 0; }
